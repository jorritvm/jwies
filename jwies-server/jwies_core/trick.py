...
This module *computes the legal set*: validation becomes
...
def trick_winner(trick: Sequence[PlayedCard], trump: Suit | None) -> Seat:
    ...
    Trump beats the led suit, the led suit beats a discard, and rank decides
    within a suit - expressed as a sort key.
    """
    if not trick:
