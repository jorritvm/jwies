...
Data, not code: how many tricks a contract promises, where the trump comes
from, who leads, and how many players declare it.
...
holds only the invariant shape. Adding pico later needs only a new entry here
and a position in the ladder.
"""
...
# Ranked low to high, following docs/game/rules.md section 4.1. The ranks here
