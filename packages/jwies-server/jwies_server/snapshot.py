...
because it needs nothing from it: given a table's occupants, its engine and a
presenter, the result is a pure function of the arguments - no queue, no event
loop, no sockets. That is what makes it testable in three lines.
