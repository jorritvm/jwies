...
Ported from the pre-refactor ``player_helper_classes.py``. The one substantive
change: ``GraphicCard`` no longer builds a 52-card pydealer deck in its
constructor just to look up a suit - it takes the wire code and maps it to an
SVG element id directly.
"""
