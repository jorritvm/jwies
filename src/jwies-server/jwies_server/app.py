...
This process is the *game* server and nothing else: a websocket endpoint plus a
little read-only HTTP for health checks and the lobby list. It serves no HTML,
CSS or JavaScript.
