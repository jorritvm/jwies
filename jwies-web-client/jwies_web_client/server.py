...
Deliberately separate from ``jwies-server``: this process only hands out
files, and keeps running when the game server is down or being restarted.
Players still get the page; it will simply tell them it cannot reach the
game.
