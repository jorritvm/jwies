...
class TestCardTranslation:
    # The parametrized check that this table agrees with jwies_core's engine
    # for all 52 cards lives in ../tests instead: this project has
    # no dependency on jwies_core, and that stays true on purpose.
